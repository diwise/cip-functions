...
// 			ProcessFunctionUpdatedFunc: func(ctx context.Context, msg events.FunctionUpdated) error {
...
func (mock *MessageProcessorMock) ProcessFunctionUpdated(ctx context.Context, msg events.FunctionUpdated) error {
